  ...
  return (
    <header className="sticky top-0 z-50 bg-[#FAFAFA] ">
      <Container className="py-6! relative">
        ...
        {/* Menu Mobile */}
        <ul
          className={`lg:hidden absolute top-full left-0 w-screen h-screen bg-[#6B8E23] text-[#ffff] flex flex-col items-center justify-center gap-8 text-2xl transition-transform duration-500 z-40 ${
